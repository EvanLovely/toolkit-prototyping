	...
	<article id="main" role="main">
		<div class="tabWrap">
			...
			<div id="log" class="clearfix">
				...
				<div class="view view-photo-gallery">
					<a href="#" class="action">View Slideshow</a>
					<br />
					<br />
					...
					<ul class="pager floatRight">
					    <li class="pager-current first">1</li>
					    <li class="pager-item"><a class="active" href="/node?page=1">2</a></li>
					    <li class="pager-item"><a class="active" href="/node?page=2">3</a></li>
					    <li class="pager-ellipsis">&#8230;</li>
					    <li class="pager-next"><a class="active" href="/node?page=1">next &#8250;</a></li>
					</ul><!-- /.pager -->
					            ...
					            <li class="views-row-1 views-row views-row-odd views-row-first">
					                <div class="views-field-image">
					                    <span class="field-content">
					                    	<img src="/css/img/img.png" alt="" class="liquid" />
					                    </span>
					                </div>
					
					                <div class="views-field-caption">
					                    <span class="field-content">Caption</span>
					                </div>
					            </li>
